...
const contactsContainer = () => {
    ...
    const { setDirectMessagesContacts, directMessagesContacts, channels, setChannels, selectedChatType } = useAppStore()
    ...
    return <div className={`relative md:w-[35vw] lg:w-[30vw] xl:w-[20vw] bg-[#1b1c24] border-r-2 border-[#2f303b] w-full ${selectedChatType ? 'hidden md:block' : 'block'}`}>
        <div className="pt-3">
            <Logo />
        </div>
        <div className="my-5">
